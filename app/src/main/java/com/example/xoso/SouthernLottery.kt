...
import com.example.xoso.databinding.FragmentSouthernLotteryBinding
...
class SouthernLottery : Fragment() {
    @RequiresApi(Build.VERSION_CODES.O)
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val binding: FragmentSouthernLotteryBinding = DataBindingUtil.inflate(
            inflater, R.layout.fragment_southern_lottery, container, false
        )
        ...
        val getArgs = arguments?.let { SouthernLotteryArgs.fromBundle(it) }
...
//            Log.d("danhsach",dau[0].toString())
    ...
    private fun extracted(binding : FragmentSouthernLotteryBinding, emptyList: MutableList<List<String>>){
        binding.giaiDB =
        ...
        binding.giai8 =
            ResultsInfoLottery(emptyList[8][0], emptyList[8].subList(1, emptyList[8].size))
    }
